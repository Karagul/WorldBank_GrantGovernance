...
ggplot(corrupgrant, aes(fill=Region, y=prop, x=Region)) + 
    ...
    #ggtitle("Scale of the means of grant and effectiveness") +
    facet_wrap(~dattype) +
    #theme_ipsum() +
  coord_flip()+
...
Considering a scotter plot, for the same variables, but by region, only the graphic related to Africa reveals that grants tend to increase with high perception of government effectiveness. However, this relation seems to bo weak. 
